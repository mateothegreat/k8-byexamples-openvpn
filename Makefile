...
APP		?= openvpn
DNS		?= <INSERT DNS SERVICE IP HERE LIKE: 10.10.10.10>
PODS_SUBNET	?= <INSERT POD SUBNET HERE LIKE: 10.10.0.0 255.255.0.0>
SERVICES_SUBNET	?= <INSERT SERVICES SUBNET HERE LIKE: 10.10.0.0 255.255.255.0>
export
